    ...
    <div class="kotak-verifikasi shadow text-center">
        <div class="progress mb-4 mt-2" style="height: 25px;">
            <div class="progress-bar progress-bar-striped progress-bar-animated bg-main2" role="progressbar"
                style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span
                    class="font-poppins">75%</span></div>
        </div>
        <h1 class="text-main fw-bold font-poppins">Change Your Password</h1>
            ...
            <div class="col-md-10">
                <form action="/change-password" method="POST">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <label for="password" class="font-poppins text-main3"><small>Enter your new
                    ...
                    <div class="form-floating mb-4">
                        <input type="password"
                            ...
                            autocomplete="off">
                        <label for="confirmpassword" class="font-poppins text-main3"><small>Confirm your new
                                password</small></label>
